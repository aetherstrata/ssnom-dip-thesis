...
\begin{figure}[h]
	...
	\begin{tikzpicture}
		...
		\draw[Aquamarine, line width=1mm, decorate, decoration={random steps,segment length=5pt,amplitude=3pt}] 
			...
			-- (3,-0.2);
	\end{tikzpicture}
	\caption[Principio di funzionamento di un microscopio a-SNOM]{
		Principio di funzionamento di un microscopio \acrshort{asnom}}
